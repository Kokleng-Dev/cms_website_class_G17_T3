...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin._client.update', $data->id) }}" method="post"  enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-4 mb-3">
                    ...
                    <input type="text" class="form-control" name="website" value="{{ $data->website }}" id="website" required>
                </div>
                <div class="col-4 mb-3">
